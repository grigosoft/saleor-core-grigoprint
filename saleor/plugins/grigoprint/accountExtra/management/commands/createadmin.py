...
class Command(BaseCommand):
    help = "Used to create a AdminUser."
            ...
            if field.many_to_many:
                if (
                    ...
                    parser.add_argument(
                        ...
                        action="append",
                        help=(
                            f"Specifies the {field_name} for the Admin. Can be "
                            "used multiple times."
                        ),
                    )
            else:
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            self.stdout.write(
                "Admin creation skipped due to not running in a TTY. "
                "You can run `manage.py Admin` in your project "
